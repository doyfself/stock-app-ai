...
def get_stock_data(params):
    ...
    next_day_timestamp = current_timestamp + ONE_DAY_MS
    url = f"https://stock.xueqiu.com/v5/stock/chart/kline.json?symbol={code}&begin={next_day_timestamp}&period={period}&type=before&count=-100&indicator=kline,pe,pb,ps,pcf,market_capital,agt,ggt,balance"
